...
void Manifold::Solve( void )
{
	...
	if(A->GetColliderType() == RigidBody::eCircle &&  B->GetColliderType() == RigidBody::eCircle )
	{
		CircletoCircle(this , A , B);
	}
    if(A->GetColliderType() == RigidBody::eCircle &&  B->GetColliderType() == RigidBody::ePoly )
	{
		CircletoPolygon(this , A , B);
	}
	if(A->GetColliderType() == RigidBody::ePoly &&  B->GetColliderType() == RigidBody::eCircle )
	{
		PolygontoCircle(this , A , B);
	}
	if(A->GetColliderType() == RigidBody::ePoly &&  B->GetColliderType() == RigidBody::ePoly )
	{
		PolygontoPolygon(this , A , B);
	}
}
