...
{
	if(A->GetCollider() == Collider::Circular &&  B->GetCollider() == Collider::Circular )
	{
		CircletoCircle(this , A , B);
	}
	if(A->GetCollider() == Collider::Circular &&  B->GetCollider() == Collider::Rectangles )
	{
		CircletoPolygon(this , A , B);
	}
	if(A->GetCollider() == Collider::Rectangles &&  B->GetCollider() == Collider::Circular )
	{
		PolygontoCircle(this , A , B);
	}
	if(A->GetCollider() == Collider::Rectangles &&  B->GetCollider() == Collider::Rectangles )
	{
